...
test("renders theme switcher", () => {
  ...
  expect(
    ...
    "Light theme should not be checked by default",
  ).not.toBeChecked();
  expect(
  ...
  expect(
    ...
    "Dark theme should not be checked by default",
  ).not.toBeChecked();
});
...
test("switches to light theme", () => {
  ...
  expect(
    screen.getByLabelText("System"),
    "System theme should not be checked",
  ).not.toBeChecked();
  expect(
    screen.getByLabelText("Light"),
    "Light theme should be checked",
  ).toBeChecked();
  expect(
    screen.getByLabelText("Dark"),
    "Dark theme should not be checked",
  ).not.toBeChecked();
  expect(
    localStorage.getItem("theme"),
    "Theme should be saved to local storage",
  ).toEqual("light");
});
...
test("switches to dark theme", () => {
  ...
  expect(
    screen.getByLabelText("Light"),
    "Light theme should not be checked",
  ).not.toBeChecked();
  expect(
    screen.getByLabelText("Dark"),
    "Dark theme should be checked",
  ).toBeChecked();
  expect(
    localStorage.getItem("theme"),
    "Theme should be saved to local storage",
...
test("switches to system theme", () => {
  ...
  expect(
    screen.getByLabelText("System"),
    "System theme should be checked",
  ).toBeChecked();
  expect(
    screen.getByLabelText("Light"),
    "Light theme should not be checked",
